...
public class TechDetailsData
{
    ...
    @JsonCreator
    private TechDetailsData(@JsonProperty("technology") final String technology,
                            @JsonProperty("_2g_bands") final String bands2g,
                            @JsonProperty("_3g_bands") final String bands3g,
                            @JsonProperty("_4g_bands") final String bands4g)
    {
    ...
    public static final class Builder
    {
        ...
        public TechDetailsData build()
        {
            return new TechDetailsData(technology, bands2g, bands3g, bands4g);
        }
    }
}
